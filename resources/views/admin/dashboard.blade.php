        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-4xl font-bold mt-1">{{ $stats['halls'] }}</p>
                            <div class="flex gap-2 mt-2">
                                <span
                                    class="bg-white/20 px-2 py-0.5 rounded text-[10px] font-bold">{{ $stats['booked_halls'] }}
                                    Booked</span>
                                <span
                                    class="bg-white/20 px-2 py-0.5 rounded text-[10px] font-bold">{{ $stats['halls'] - $stats['booked_halls'] }}
                                    Free</span>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-4xl font-bold mt-1">{{ $stats['rooms'] }}</p>
                            <div class="flex gap-2 mt-2">
                                <span
                                    class="bg-white/20 px-2 py-0.5 rounded text-[10px] font-bold">{{ $stats['booked_rooms'] }}
                                    Booked</span>
                                <span
                                    class="bg-white/20 px-2 py-0.5 rounded text-[10px] font-bold">{{ $stats['rooms'] - $stats['booked_rooms'] }}
                                    Free</span>
                            </div>
                        </div>
                        <div class="bg-white/20 p-3 rounded-full">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="text-blue-100 text-sm font-medium uppercase tracking-wider">Total Bookings</p>
                            <p class="text-4xl font-bold mt-1">{{ $stats['bookings'] }}</p>
                        </div>
                        <div class="bg-white/20 p-3 rounded-full">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="text-yellow-100 text-sm font-medium uppercase tracking-wider">Total Revenue</p>
                            <p class="text-4xl font-bold mt-1">${{ number_format($stats['revenue'], 2) }}</p>
                        </div>
                        <div class="bg-white/20 p-3 rounded-full">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('admin.halls.create') }}"
                        class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition">Add
                        Hall</a>
                    <a href="{{ route('admin.rooms.create') }}"
                        class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 px-4 rounded-lg transition">Add
                        Room</a>
                    <a href="{{ route('admin.bookings.index') }}"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition">View
                        Bookings</a>
                </div>
            </div>
